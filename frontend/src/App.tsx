...
const App = () => {
  ...
  return (
    <>
      ...
      <div className="hidden sm:flex fixed bottom-6 right-6 z-[9999] flex-col items-end gap-3">
        {isOpen && (
          <div className="w-[390px] h-[560px] rounded-2xl shadow-2xl border border-stone-200 overflow-hidden">
            {chatPanel}
          </div>
        )}
        <button
